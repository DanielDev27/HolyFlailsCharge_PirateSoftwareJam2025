	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord26 = input.ase_texcoord9.xy * appendResult348 + appendResult347;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 appendResult348 = (float2(_TilingX , _TilingY));
				float2 appendResult347 = (float2(_OffsetX , _OffsetY));
				float2 texCoord26 = input.ase_texcoord3.xy * appendResult348 + appendResult347;
				float2 panner37 = ( 1.0 * _Time.y * appendResult349 + texCoord26);
				float4 tex2DNode39 = tex2D( _Foam_Texture, panner37 );
				float foam62 = saturate( ( ( ( 1.0 - saturate( pow( ( distanceDepth170 + _FoamShoreline ) , _FoamFalloff ) ) ) * ( ( tex2DNode39.r + 2.0 ) / 3.0 ) ) + tex2DNode39.r ) );
				float waterOpacity218 = ( ( (_OpacityMin + (saturate( ( distanceDepth234 / _OpacityFalloff ) ) - 0.0) * (1.0 - _OpacityMin) / (1.0 - 0.0)) * _Opacity ) + ( foam62 * _FoamOpacity ) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 appendResult348 = (float2(_TilingX , _TilingY));
				float2 appendResult347 = (float2(_OffsetX , _OffsetY));
				float2 texCoord26 = input.ase_texcoord5.xy * appendResult348 + appendResult347;
				float2 panner37 = ( 1.0 * _Time.y * appendResult349 + texCoord26);
				float4 tex2DNode39 = tex2D( _Foam_Texture, panner37 );
				float foam62 = saturate( ( ( ( 1.0 - saturate( pow( ( distanceDepth170 + _FoamShoreline ) , _FoamFalloff ) ) ) * ( ( tex2DNode39.r + 2.0 ) / 3.0 ) ) + tex2DNode39.r ) );
				float4 lerpResult141 = lerp( lerpResult121 , float4(1,1,1,0) , ( foam62 * _FoamOpacity ));
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = waterOpacity218;
...
Node;AmplifyShaderEditor.SamplerNode;39;-3298.166,682.169;Inherit;True;Property;_Foam_Texture;Foam_Texture;21;0;Create;True;0;0;0;False;0;False;-1;None;d1ee92b23e8161c498a05646ff127bbf;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;101;-3501.157,-266.0128;Float;False;Property;_DeepColour;Deep Colour;7;0;Create;True;0;0;0;False;0;False;0.04705882,0.3098039,0.1960784,0;0.1312871,0.574,0.5159892,0;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;176;-3406.729,7.462919;Float;False;Property;_VeryDeepColour;Very Deep Colour;8;0;Create;True;0;0;0;False;0;False;0.05959199,0.08247829,0.191,0;0.09000818,0.3001718,0.3867924,0;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;108;-3755.145,-321.7485;Float;False;Property;_ShallowColour;Shallow Colour;6;1;[Header];Create;True;1;Colour;0;0;False;0;False;0.9607843,0.7882353,0.5764706,0;0.3261999,0.8392157,0.1686273,0;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;330;-1212.688,-72.92902;Inherit;False;Property;_FoamEmitColour;Foam Emit Colour;34;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;125;-2649.173,49.14542;Float;False;Constant;_Color0;Color 0;-1;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;336;-994.0917,-394.7377;Inherit;False;Property;_DepthGlowColour;Depth Glow Colour;31;1;[Header];Create;True;1;Glow;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;361;-3287.625,1271.264;Inherit;True;Property;_Ripples;Ripples;28;1;[Header];Create;True;1;Normal Map;0;0;False;0;False;-1;None;bd6f803a7aa2a134693d786c0b77bdaa;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;379;0,100;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=8580507703C832D4BCDFE0532A05F5932CE45CDA